            ...
            <div class="flex justify-between items-center">
              ...
              <div class="flex gap-2 relative">
                ...
                <BaseIcon
                  ...
                  title={props.readonly ? props.readonlyTip : '批量删除'}
                ...
                <BaseIcon
                  disabled={props.readonly}
                  title={props.readonly ? props.readonlyTip : '导入'}
                      ...
                      options: () => (
                        <div class="flex flex-col gap-2">
                          <BaseButton class="w-full" onClick={() => emit('exportXlsx')}>
                            {props.exportXlsxLoading ? <IconEosIconsLoading /> : '导出为xlsx文件'}
                          </BaseButton>
                          <BaseButton class="w-full" onClick={() => emit('exportJson')}>
                            {props.exportJsonLoading ? <IconEosIconsLoading /> : '导出为json文件'}
                          </BaseButton>
                        </div>
                      ),
                    }}
                ...
                <BaseIcon
                  disabled={props.readonly}
                  title={props.readonly ? props.readonlyTip : '添加单词'}
                ...
                <BaseIcon
                  ...
                  title={props.readonly ? props.readonlyTip : '改变顺序'}
